...
//! voir les tests en bas de fichier.
//!
//! Migré depuis `spikes/s3-window-linux/src/topmost.rs` (§17.2 du plan, critère de sortie de
...
//! le détail). Pas encore câblé à un vrai rendu winit X11 côté production (voir
//! `docs/plan-architecture.md` §17.2, section « État » — reste du critère de sortie).
//!
