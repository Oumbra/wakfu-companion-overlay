...
/// contient 380 lignes de soin (« X: +N PV ») et une ligne d'armure (« Anonyme-Ouginak1: 460 Armure »,
...
fn soins_et_armure_du_vrai_log_arrivent_jusquau_recap() {
    ...
    assert_eq!(
        armure, 460,
        "la ligne « Anonyme-Ouginak1: 460 Armure » du vrai log doit créditer son porteur"
    );
}
