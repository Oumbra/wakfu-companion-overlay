...
//! premier combat du rejeu (six alliés, `Erz-Wouaf`, `Néo-Erz-Alcool`, `Erz-Poker`… contre six
...
fn bloc_de_sorts_selection_par_le_cadre() {
    ...
    //    Erz-Wouaf, capture identique à l'étape 1) — l'épingle ennemie n'a touché à rien de ce
...
/// médaillon d'Erz-Wouaf ne porte plus ni liseré ni point. Les portraits, les barres et le switch,
