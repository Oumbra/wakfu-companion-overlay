...
//!
//! ## Pas encore utilisé en production, et pourquoi
//!
//! Les quatre boutons icône de l'overlay (lien externe et Options dans Combat, « + » et « − » dans
//! le Suivi) **continuent de passer par `panels::icon_button`**. Leur socle est pourtant déjà celui
//! du design system : `crates/overlay-ui/assets/ui/button-background.png` est octet pour octet
...
//! bruts. Les migrer changerait le rendu de deux panneaux qui sortent du périmètre du plan de
//! finalisation de la modale, et aucune capture de référence ne permet d'arbitrer laquelle des deux
//! normalisations est la bonne. À reprendre quand ces panneaux seront eux-mêmes au chantier.
//!
...
impl Widget for IconButton {
    fn ui(self, ui: &mut Ui) -> Response {
        ...
        if ui.is_rect_visible(rect) {
            ...
            let icon_size = design.native_size(self.icon) * scale;
