...
//! `main.rs`), mais c'est un exécutable **console** : lancé par le shell, il ouvrait une console
//! noire le temps de sa course — vu par l'utilisateur le 2026-09-14, jugé inélégant à raison.
//! Celui-ci est un exécutable **fenêtré sans fenêtre** (`windows_subsystem = "windows"`) : rien à
//! l'écran, et un binaire minuscule qui démarre plus vite que l'overlay. `notify::register_identity`
//! l'enregistre comme gestionnaire s'il est à côté de l'overlay.
//!
